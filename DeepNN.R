...
Deep_NeuralNetwork_Model <- function(XTrain, YTrain, n_h = c(5,4,3), alpha = 0.01, num_iters = 10, type = "relu", XTest = NULL, YTest = NULL, regularize = F, momentum = F, Batch_Norm = F)
{
